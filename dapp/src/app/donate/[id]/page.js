...
export default function Donate() {
    ...
    useEffect(() => {
        setMessage("Buscando a campanha...aguarde...")
    ...
    function btnDonateClick() {
        ...
        donate(campaign.id, donation)
            .then(tx => {
                setMessage("Doação realizada, obrigado. Em alguns segundos o saldo será atualizado.")
                setDonation(0)
            })
            .catch(err => {
                console.error(err)
            ...
            <div className="container">
                ...
                <div className="row flex-lg-row-reverse align-items-center g-5">
                    <div className="col-7">
                        {
                            campaign.videoUrl
                                ? <iframe width="100%" height="480" src={`https://www.youtube.com/embed/${campaign.videoUrl}`} />
